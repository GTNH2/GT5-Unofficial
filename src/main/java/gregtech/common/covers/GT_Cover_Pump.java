...
public class GT_Cover_Pump
            ...
            if (tTank2 != null) {
                ...
                if (aCoverVariable % 2 == 0) {
                    ...
                    if (tLiquid != null) {
                        ...
                        if (tLiquid.amount > 0) {
                            if (aSide != 1 && aSide != 0 && aTileEntity.getUniversalEnergyCapacity() >= Math.min(1, tLiquid.amount / 10)) {
                                if (aTileEntity.isUniversalEnergyStored(Math.min(1, tLiquid.amount / 10))) {
                                    aTileEntity.decreaseStoredEnergyUnits(Math.min(1, tLiquid.amount / 10), true);
    ...
    private class GT_PumpGUICover extends GT_GUICover {
        ...
        public GT_PumpGUICover(byte aSide, int aCoverID, int aCoverVariable, ICoverable aTileEntity) {
            ...
            new GT_GuiIconButton(this, 2, startX, startY + spaceY, GT_GuiIcon.CHECKMARK).setTooltipText(trans("224","Ignore"));
            new GT_GuiIconButton(this, 3, startX + spaceX, startY + spaceY, GT_GuiIcon.REDSTONE_ON).setTooltipText(trans("225","Conditional"));
            new GT_GuiIconButton(this, 4, startX + spaceX * 2, startY + spaceY, GT_GuiIcon.REDSTONE_OFF).setTooltipText(trans("226","Invert Condition"));
            new GT_GuiIconButton(this, 5, startX, startY + spaceY * 2, GT_GuiIcon.ALLOW_INPUT).setTooltipText(trans("227","Allow Input"));
            new GT_GuiIconButton(this, 6, startX + spaceX, startY + spaceY * 2, GT_GuiIcon.BLOCK_INPUT).setTooltipText(trans("228","Block Input"));
        }
