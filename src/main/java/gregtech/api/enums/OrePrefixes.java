...
public enum OrePrefixes {
    ...
    ingotHot("Hot Ingots", "Hot ", " Ingot", true, true, false, false, false, false, false, true, false, false, B[1], M, 16, 12), // A hot Ingot, which has to be cooled down by a Vacuum Freezer.
    ingot("Ingots", "", " Ingot", true, true, false, false, false, false, false, true, false, false, B[1], M, 64, 11), // A regular Ingot. Introduced by Eloraam
    ...
    gem("Gemstones", "", "", true, true, true, false, false, false, true, true, false, false, B[2], M, 64, 8), // A regular Gem worth one Dust. Introduced by Eloraam
    ...
    dustImpure("Impure Dusts", "Impure Pile of ", " Dust", true, true, false, false, false, false, false, true, false, true, B[3], M, 64, 3), // Dust with impurities. 1 Unit of Main Material and 1/9 - 1/4 Unit of secondary Material
    ...
    dust("Dusts", "", " Dust", true, true, false, false, false, false, false, true, false, false, B[0] | B[1] | B[2] | B[3], M, 64, 2), // Pure Dust worth of one Ingot or Gem. Introduced by Alblaka.
    ...
    plate("Plates", "", " Plate", true, true, false, false, false, false, true, true, false, false, B[1] | B[2], M, 64, 17), // Regular Plate made of one Ingot/Dust. Introduced by Calclavia
    ...
    stickLong("Long Sticks/Rods", "Long ", " Rod", true, true, false, false, false, false, true, true, false, false, B[1] | B[2], M, 64, 54), // Stick made of an Ingot.
    ...
    cellPlasma("Cells of Plasma", "", " Plasma Cell", true, true, true, true, false, false, false, true, false, false, B[5], M, 64, 31), // Hot Cell full of Plasma, which can be used in the Plasma Generator.
    cellMolten("Cells of Molten stuff", "Molten ", " Cell", true, true, true, true, false, false, false, true, false, false, 0, M, 64, 31), // Hot Cell full of molten stuff, which can be used in the Plasma Generator.
    cell("Cells", "", " Cell", true, true, true, true, false, false, true, true, false, false, B[4] | B[8], M, 64, 30), // Regular Gas/Fluid Cell. Introduced by Calclavia
    ...
    toolHeadShovel("Shovel Heads", "", " Shovel Head", true, true, false, false, false, false, true, true, false, false, B[6], M, 16, 34), // consisting out of 1 Ingots.
    toolHeadUniversalSpade("Universal Spade Heads", "", " Universal Spade Head", true, true, false, false, false, false, true, true, false, false, B[6], M, 16, 43), // consisting out of 1 Ingots.
    ...
    toolHeadScrewdriver("Screwdriver Tips", "", " Screwdriver Tip", true, true, false, false, false, false, true, false, false, false, B[6], M, 16, 47), // consisting out of 1 Ingots.
    ...
    public static void initMaterialComponents() {
        ...
        for (Materials aMaterial : Materials.values()) {
            if (aMaterial.mMetaItemSubID > 0) {
                ...
                //Rods
                if (!enableUnusedRods && (aMaterial.mTypes & 0x40) == 0 && !(aMaterial == Materials.Titanium || aMaterial == Materials.Chrome || aMaterial == Materials.Iron || aMaterial == Materials.Tin || aMaterial == Materials.Osmium || aMaterial == Materials.Iridium || aMaterial == Materials.Neutronium || aMaterial == Materials.Bronze || aMaterial == Materials.WroughtIron || aMaterial == Materials.Steel || aMaterial == Materials.StainlessSteel || aMaterial == Materials.PigIron || aMaterial == Materials.TungstenSteel || aMaterial == Materials.HSSE || aMaterial == Materials.HSSG || aMaterial == Materials.Aluminium || aMaterial == Materials.Copper || aMaterial == Materials.Neodymium || aMaterial == Materials.Europium || aMaterial == Materials.Platinum || aMaterial == Materials.Gold || aMaterial == Materials.Uranium235 || aMaterial == Materials.Plutonium241 || aMaterial == Materials.Americium || aMaterial == Materials.Brass || aMaterial == Materials.Electrum || aMaterial == Materials.NaquadahEnriched || aMaterial == Materials.CobaltBrass || aMaterial == Materials.IronMagnetic || aMaterial == Materials.SteelMagnetic || aMaterial == Materials.NeodymiumMagnetic || aMaterial == Materials.Samarium || aMaterial == Materials.SamariumMagnetic || aMaterial == Materials.VanadiumGallium || aMaterial == Materials.Diamond || aMaterial == Materials.Wood || aMaterial == Materials.Plastic || aMaterial == Materials.Lead || aMaterial == Materials.SolderingAlloy || aMaterial == Materials.Lapis || aMaterial == Materials.Lazurite || aMaterial == Materials.Sodalite || aMaterial == Materials.PolyvinylChloride))
            ...
            if (aMaterial.mMetaItemSubID > 0) {
                ...
                if (enablePerItemSettings) {
                    ...
                    for (OrePrefixes aPrefix : mPreventableComponents) {
                        ...
                        if (aEnableComponent) { //Enable component if true and is not already in enabled list
                            aPrefix.enableComponent(aMaterial);
                        } else { //Disable component if false and is not already in disabled list
